...
# write data and probabilities to csvs named r_data and r_probability respectively
write.csv(data, file = "r_data.csv")
write.csv(probabilities, file = "r_probability.csv")
